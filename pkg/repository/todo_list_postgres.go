...
func (r *TodoListPostgres) Create(userId int, list newtodo.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoListPostgres) GetById(userId, listId int) (newtodo.TodoList, error) {
	var list newtodo.TodoList
...
func (r *TodoListPostgres) Update(userId, listId int, input newtodo.UpdateListInput) error {
